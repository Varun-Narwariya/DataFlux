    ...
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {user ? (
            <div className="flex items-center gap-2">
              <a href={ROUTES.DASHBOARD} className="hidden sm:flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-red-600 px-3 py-1.5 rounded-lg hover:bg-red-50 transition">
            ...
            <>
              <a href={ROUTES.LOGIN} className="hidden sm:block text-sm font-semibold text-gray-700 hover:text-red-600 px-3 py-1.5 rounded-lg hover:bg-red-50 transition">
                Login
              </a>
              <a href={ROUTES.SIGNUP} className="text-sm font-bold text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-xl transition shadow-sm">
                Sign Up Free
              </a>
            </>
          )}
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-3 flex flex-col gap-1">
          {NAV_LINKS.map((link) => (
            <a key={link.label} href={link.href} className="text-sm text-gray-600 hover:text-red-600 py-2 px-3 rounded-lg hover:bg-red-50 transition font-medium">
              {link.label}
            </a>
          ))}
          {!user && (
            <a href={ROUTES.LOGIN} className="text-sm text-gray-600 hover:text-red-600 py-2 px-3 rounded-lg hover:bg-red-50 transition font-medium">
              Login
            </a>
          )}
        </div>
